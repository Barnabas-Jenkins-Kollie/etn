...
<div class="container-fluid about  py-5">
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-xl-5">
                <div class="h-100">
                    <img src="assets/img/logo.png" class="img-fluid w-100 h-100" alt="Image">
                </div>
            </div>
            <div class="col-xl-7">
                ...
                <p class="fs-5 mb-4">Liberia, endowed with abundant natural resources, faces enduring challenges of
                    ...
                    by the exploitation of these resources to the detriment of local communities. Despite this wealth,
                    Liberia's most
                    valuable asset, its human capital, remains largely untapped and underutilized. One critical issue is
                    the absence of
                    structured programs to identify, honor, nurture and empower the nation's brightest young minds,
                    particularly
                    high-achieving senior secondary school graduates who lack avenues for further growth and development
                    into future leaders
                    and change-makers.</p>
                                ...
                                <div class="col-12">
                                    <div class="d-flex">
                                        <div class="text-start my-auto">
                                            <h5 class="text-uppercase mb-3">Excellence, Leadership, Community Service,
                                                Accountability</h5>
                                            <p class="mb-4">
                                            </p>
                                            <!-- <div class="d-flex align-items-center justify-content-start">
                                                <a class="btn-hover-bg btn btn-danger text-white py-2 px-4"
                                                    href="#">Read
                                                    More</a>
                                            </div> -->
                                        </div>
...
<div class="container-fluid volunteer py-5 mt-5">
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-7">
                <h5 class="text-uppercase text-danger">Donors & Partners</h5>
                ...
                <div class="row g-4">
                    <div class="col-lg-6">
                        <div class="volunteer-img">
                            <img src="assets/img/bcc.jpg" class="img-fluid w-100">
                            <div class="">
                                <!-- <a href="https://bluecrest.edu.lr/" target="_blank"
                                    rel="noopener noreferrer">BLUECREST</a> -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="volunteer-img">
                            <div class="">
                                <img src="assets/img/education.png" class="img-fluid w-100" alt="Image">
